...
class ContactGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_group" do
    assert_difference("ContactGroup.count") do
      post contact_groups_url, params: { contact_group: { description: @contact_group.description, name: @contact_group.name } }
    end
  ...
  test "should update contact_group" do
    patch contact_group_url(@contact_group), params: { contact_group: { description: @contact_group.description, name: @contact_group.name } }
