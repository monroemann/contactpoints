...
class InteractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interaction" do
    assert_difference("Interaction.count") do
      post interactions_url, params: { interaction: { description: @interaction.description, name: @interaction.name } }
    end
  ...
  test "should update interaction" do
    patch interaction_url(@interaction), params: { interaction: { description: @interaction.description, name: @interaction.name } }
